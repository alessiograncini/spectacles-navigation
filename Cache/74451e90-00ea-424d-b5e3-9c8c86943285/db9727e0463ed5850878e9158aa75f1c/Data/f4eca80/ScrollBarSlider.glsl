...
SC_DECLARE_TEXTURE(Tweak_N1); // Title: Slider Map
uniform NF_PRECISION             float4 Tweak_N5; // Title: Slider Color	
...
#define Node0_Texture_2D_Sample( UVCoord, Color, Globals ) Color = SC_SAMPLE_TEX_R(Tweak_N1, UVCoord, 0.0)
void Node5_Color_Parameter( out float4 Output, ssGlobals Globals ) { Output = Tweak_N5; }
...
void main() 
{
	...
	
	{
		...
		float4 Output_N3 = float4(0.0); Node3_Multiply( Color_N0, Output_N5, Output_N3, Globals );
