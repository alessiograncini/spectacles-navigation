...
void main() 
{
	...
	
	{
		...
		float4 Value_N7 = float4(0.0); Node7_Gradient( Color_N1.x, NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 0.0 ), Port_Value0_N007 ), NF_PORT_CONSTANT( float( 0.0 ), Port_Position1_N007 ), NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value1_N007 ), NF_PORT_CONSTANT( float( 0.76 ), Port_Position2_N007 ), NF_PORT_CONSTANT( float4( 1.0, 0.854902, 0.270588, 1.0 ), Port_Value2_N007 ), NF_PORT_CONSTANT( float4( 1.0, 1.0, 1.0, 1.0 ), Port_Value3_N007 ), Value_N7, Globals );
		float4 Output_N3 = float4(0.0); Node3_Is_Less( Value_N7, NF_PORT_CONSTANT( float( 0.005 ), Port_Input1_N003 ), Output_N3, Globals );
		float4 Output_N2 = float4(0.0); Node2_Discard( Value_N7, Output_N3.x, Output_N2, Globals );
