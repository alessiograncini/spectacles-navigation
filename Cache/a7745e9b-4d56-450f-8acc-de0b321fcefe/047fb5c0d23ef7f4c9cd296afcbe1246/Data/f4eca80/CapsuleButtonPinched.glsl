...
uniform NF_PRECISION float4 Port_Value0_N067;
uniform NF_PRECISION float Port_Position1_N067;
uniform NF_PRECISION float4 Port_Value1_N067;
uniform NF_PRECISION float Port_Position2_N067;
uniform NF_PRECISION float4 Port_Value2_N067;
uniform NF_PRECISION float Port_Position3_N067;
uniform NF_PRECISION float4 Port_Value3_N067;
uniform NF_PRECISION float4 Port_Value4_N067;
...
void Node67_Gradient( in float Ratio, in float4 Value0, in float Position1, in float4 Value1, in float Position2, in float4 Value2, in float Position3, in float4 Value3, in float4 Value4, out float4 Value, ssGlobals Globals )
{ 
...
void main() 
{
	...
	
	{
		...
		float4 Value_N67 = float4(0.0); Node67_Gradient( Export_N55.x, NF_PORT_CONSTANT( float4( 1.0, 0.866148, 0.196918, 1.0 ), Port_Value0_N067 ), NF_PORT_CONSTANT( float( 0.18 ), Port_Position1_N067 ), NF_PORT_CONSTANT( float4( 0.2, 0.133333, 0.0399939, 1.0 ), Port_Value1_N067 ), NF_PORT_CONSTANT( float( 0.34 ), Port_Position2_N067 ), NF_PORT_CONSTANT( float4( 0.533684, 0.444739, 0.177905, 1.0 ), Port_Value2_N067 ), NF_PORT_CONSTANT( float( 0.58 ), Port_Position3_N067 ), NF_PORT_CONSTANT( float4( 0.976471, 0.893019, 0.475761, 1.0 ), Port_Value3_N067 ), NF_PORT_CONSTANT( float4( 1.0, 0.916335, 0.498039, 1.0 ), Port_Value4_N067 ), Value_N67, Globals );
		...
		float4 Output_N34 = float4(0.0); Node34_Mix( Value_N67, NF_PORT_CONSTANT( float4( 1.0, 0.890196, 0.34902, 1.0 ), Port_Input1_N034 ), Rim_N23, Output_N34, Globals );
		float4 Output_N100 = float4(0.0); Node100_Add( Output_N2, Output_N34, Output_N100, Globals );
