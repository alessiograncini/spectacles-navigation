...
#define Node1_Texture_2D_Parameter( UVCoord, Output, Globals ) Output = SC_SAMPLE_TEX_R(baseTex, UVCoord, 0.0)
//-----------------------------------------------------------------------------
...
void main() 
{
	...
	
	{
		...
		float4 Output_N1 = float4(0.0); Node1_Texture_2D_Parameter( UVCoord_N11, Output_N1, Globals );
