...
#define Node17_Construct_Vector( Value1, Value2, Value, Globals ) Value.rgb = Value1; Value.a = Value2
...
void main() 
{
	...
	
	{
		...
		float4 Value_N31 = float4(0.0); Node31_Gradient( Output_N29, NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value0_N031 ), NF_PORT_CONSTANT( float( 0.18 ), Port_Position1_N031 ), NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value1_N031 ), NF_PORT_CONSTANT( float( 0.43 ), Port_Position2_N031 ), NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value2_N031 ), NF_PORT_CONSTANT( float( 0.72 ), Port_Position3_N031 ), NF_PORT_CONSTANT( float4( 0.658824, 0.658824, 0.658824, 1.0 ), Port_Value3_N031 ), NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value4_N031 ), Value_N31, Globals );
		...
		float4 Output_N7 = float4(0.0); Node7_Add( Value_N31, Output_N65, Output_N7, Globals );
		...
		float4 Value_N17 = float4(0.0); Node17_Construct_Vector( Output_N7.xyz, Value_N16, Value_N17, Globals );
		float4 Output_N100 = float4(0.0); Node100_Add( Output_N2, Value_N17, Output_N100, Globals );
