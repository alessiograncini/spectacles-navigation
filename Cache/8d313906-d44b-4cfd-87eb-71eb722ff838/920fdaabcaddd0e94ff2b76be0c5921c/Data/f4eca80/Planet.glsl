...
#if defined( STUDIO )
uniform NF_PRECISION float Port_Input1_N010;
...
uniform NF_PRECISION float Port_Position3_N005;
uniform NF_PRECISION float4 Port_Value3_N005;
uniform NF_PRECISION float Port_Position4_N005;
uniform NF_PRECISION float4 Port_Value4_N005;
uniform NF_PRECISION float Port_Position5_N005;
uniform NF_PRECISION float4 Port_Value5_N005;
uniform NF_PRECISION float Port_Position6_N005;
uniform NF_PRECISION float4 Port_Value6_N005;
uniform NF_PRECISION float Port_Position7_N005;
uniform NF_PRECISION float4 Port_Value7_N005;
uniform NF_PRECISION float Port_Position8_N005;
uniform NF_PRECISION float4 Port_Value8_N005;
uniform NF_PRECISION float Port_Position9_N005;
uniform NF_PRECISION float4 Port_Value9_N005;
uniform NF_PRECISION float Port_Position10_N005;
uniform NF_PRECISION float4 Port_Value10_N005;
uniform NF_PRECISION float Port_Position11_N005;
uniform NF_PRECISION float4 Port_Value11_N005;
uniform NF_PRECISION float Port_Position12_N005;
uniform NF_PRECISION float4 Port_Value12_N005;
uniform NF_PRECISION float Port_Position13_N005;
uniform NF_PRECISION float4 Port_Value13_N005;
uniform NF_PRECISION float Port_Position14_N005;
uniform NF_PRECISION float4 Port_Value14_N005;
uniform NF_PRECISION float4 Port_Value15_N005;
uniform NF_PRECISION float Port_Rotation_N002;
uniform NF_PRECISION float2 Port_Center_N002;
uniform NF_PRECISION float4 Port_Value0_N019;
uniform NF_PRECISION float Port_Position1_N019;
uniform NF_PRECISION float4 Port_Value1_N019;
uniform NF_PRECISION float Port_Position2_N019;
uniform NF_PRECISION float4 Port_Value2_N019;
uniform NF_PRECISION float Port_Position3_N019;
uniform NF_PRECISION float4 Port_Value3_N019;
uniform NF_PRECISION float Port_Position4_N019;
uniform NF_PRECISION float4 Port_Value4_N019;
uniform NF_PRECISION float Port_Position5_N019;
uniform NF_PRECISION float4 Port_Value5_N019;
uniform NF_PRECISION float Port_Position6_N019;
uniform NF_PRECISION float4 Port_Value6_N019;
uniform NF_PRECISION float Port_Position7_N019;
uniform NF_PRECISION float4 Port_Value7_N019;
uniform NF_PRECISION float Port_Position8_N019;
uniform NF_PRECISION float4 Port_Value8_N019;
uniform NF_PRECISION float Port_Position9_N019;
uniform NF_PRECISION float4 Port_Value9_N019;
uniform NF_PRECISION float Port_Position10_N019;
uniform NF_PRECISION float4 Port_Value10_N019;
uniform NF_PRECISION float Port_Position11_N019;
uniform NF_PRECISION float4 Port_Value11_N019;
uniform NF_PRECISION float Port_Position12_N019;
uniform NF_PRECISION float4 Port_Value12_N019;
uniform NF_PRECISION float Port_Position13_N019;
uniform NF_PRECISION float4 Port_Value13_N019;
uniform NF_PRECISION float Port_Position14_N019;
uniform NF_PRECISION float4 Port_Value14_N019;
uniform NF_PRECISION float4 Port_Value15_N019;
uniform NF_PRECISION float4 Port_Input0_N001;
uniform NF_PRECISION float4 Port_Input1_N001;
uniform NF_PRECISION float3 Port_Normal_N024;
uniform NF_PRECISION float Port_Exponent_N024;
uniform NF_PRECISION float Port_Intensity_N024;
uniform NF_PRECISION float4 Port_Input2_N026;
#endif	
...
void Node6_Split_Vector( in float2 Value, out float Value1, out float Value2, ssGlobals Globals )
{ 
	Value1 = Value.x;
	Value2 = Value.y;
}
#define Node10_Is_Less( Input0, Input1, Output, Globals ) Output = ssSmaller( Input0, Input1 )
...
void Node5_Gradient( in float Ratio, in float4 Value0, in float Position1, in float4 Value1, in float Position2, in float4 Value2, in float Position3, in float4 Value3, in float Position4, in float4 Value4, in float Position5, in float4 Value5, in float Position6, in float4 Value6, in float Position7, in float4 Value7, in float Position8, in float4 Value8, in float Position9, in float4 Value9, in float Position10, in float4 Value10, in float Position11, in float4 Value11, in float Position12, in float4 Value12, in float Position13, in float4 Value13, in float Position14, in float4 Value14, in float4 Value15, out float4 Value, ssGlobals Globals )
{ 
	Ratio = fract( Ratio );
...
void Node2_Rotate_Coords( in float2 CoordsIn, in float Rotation, in float2 Center, out float2 CoordsOut, ssGlobals Globals )
{ 
	float Sin = sin( radians( Rotation ) );
	float Cos = cos( radians( Rotation ) );
	CoordsOut = CoordsIn - Center;
...
void Node19_Gradient( in float Ratio, in float4 Value0, in float Position1, in float4 Value1, in float Position2, in float4 Value2, in float Position3, in float4 Value3, in float Position4, in float4 Value4, in float Position5, in float4 Value5, in float Position6, in float4 Value6, in float Position7, in float4 Value7, in float Position8, in float4 Value8, in float Position9, in float4 Value9, in float Position10, in float4 Value10, in float Position11, in float4 Value11, in float Position12, in float4 Value12, in float Position13, in float4 Value13, in float Position14, in float4 Value14, in float4 Value15, out float4 Value, ssGlobals Globals )
{ 
	Ratio = fract( Ratio );
	...
	NF_PREVIEW_SAVE( Value, 19, false )
}
void Node7_If_else( in float Bool1, in float4 Value1, in float4 Default, out float4 Result, ssGlobals Globals )
{ 
	/* Input port: "Bool1"  */
	
	{
		float2 UVCoord_N11 = float2(0.0); Node11_Surface_UV_Coord( UVCoord_N11, Globals );
		float Value1_N6 = 0.0; float Value2_N6 = 0.0; Node6_Split_Vector( UVCoord_N11, Value1_N6, Value2_N6, Globals );
		float Output_N10 = 0.0; Node10_Is_Less( Value2_N6, NF_PORT_CONSTANT( float( 0.5 ), Port_Input1_N010 ), Output_N10, Globals );
	...
	if ( bool( Bool1 * 1.0 != 0.0 ) )
	{
		...
		{
			float2 UVCoord_N11 = float2(0.0); Node11_Surface_UV_Coord( UVCoord_N11, Globals );
			float2 CoordsOut_N12 = float2(0.0); Node12_Rotate_Coords( UVCoord_N11, NF_PORT_CONSTANT( float( 90.0 ), Port_Rotation_N012 ), NF_PORT_CONSTANT( float2( 0.5, 0.5 ), Port_Center_N012 ), CoordsOut_N12, Globals );
			float4 Value_N5 = float4(0.0); Node5_Gradient( CoordsOut_N12.x, NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value0_N005 ), NF_PORT_CONSTANT( float( 0.08 ), Port_Position1_N005 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value1_N005 ), NF_PORT_CONSTANT( float( 0.12 ), Port_Position2_N005 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value2_N005 ), NF_PORT_CONSTANT( float( 0.14 ), Port_Position3_N005 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value3_N005 ), NF_PORT_CONSTANT( float( 0.15 ), Port_Position4_N005 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value4_N005 ), NF_PORT_CONSTANT( float( 0.16 ), Port_Position5_N005 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value5_N005 ), NF_PORT_CONSTANT( float( 0.12 ), Port_Position6_N005 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value6_N005 ), NF_PORT_CONSTANT( float( 0.22 ), Port_Position7_N005 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value7_N005 ), NF_PORT_CONSTANT( float( 0.24 ), Port_Position8_N005 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value8_N005 ), NF_PORT_CONSTANT( float( 0.28 ), Port_Position9_N005 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value9_N005 ), NF_PORT_CONSTANT( float( 0.38 ), Port_Position10_N005 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value10_N005 ), NF_PORT_CONSTANT( float( 0.39 ), Port_Position11_N005 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value11_N005 ), NF_PORT_CONSTANT( float( 0.45 ), Port_Position12_N005 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value12_N005 ), NF_PORT_CONSTANT( float( 0.49 ), Port_Position13_N005 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value13_N005 ), NF_PORT_CONSTANT( float( 0.5 ), Port_Position14_N005 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value14_N005 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value15_N005 ), Value_N5, Globals );
	...
	else
	{
		...
		{
			float2 UVCoord_N11 = float2(0.0); Node11_Surface_UV_Coord( UVCoord_N11, Globals );
			float2 CoordsOut_N2 = float2(0.0); Node2_Rotate_Coords( UVCoord_N11, NF_PORT_CONSTANT( float( -90.0 ), Port_Rotation_N002 ), NF_PORT_CONSTANT( float2( 0.5, 0.5 ), Port_Center_N002 ), CoordsOut_N2, Globals );
			float4 Value_N19 = float4(0.0); Node19_Gradient( CoordsOut_N2.x, NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value0_N019 ), NF_PORT_CONSTANT( float( 0.08 ), Port_Position1_N019 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value1_N019 ), NF_PORT_CONSTANT( float( 0.12 ), Port_Position2_N019 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value2_N019 ), NF_PORT_CONSTANT( float( 0.14 ), Port_Position3_N019 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value3_N019 ), NF_PORT_CONSTANT( float( 0.15 ), Port_Position4_N019 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value4_N019 ), NF_PORT_CONSTANT( float( 0.16 ), Port_Position5_N019 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value5_N019 ), NF_PORT_CONSTANT( float( 0.12 ), Port_Position6_N019 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value6_N019 ), NF_PORT_CONSTANT( float( 0.22 ), Port_Position7_N019 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value7_N019 ), NF_PORT_CONSTANT( float( 0.24 ), Port_Position8_N019 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value8_N019 ), NF_PORT_CONSTANT( float( 0.25 ), Port_Position9_N019 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value9_N019 ), NF_PORT_CONSTANT( float( 0.27 ), Port_Position10_N019 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value10_N019 ), NF_PORT_CONSTANT( float( 0.33 ), Port_Position11_N019 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value11_N019 ), NF_PORT_CONSTANT( float( 0.39 ), Port_Position12_N019 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value12_N019 ), NF_PORT_CONSTANT( float( 0.42 ), Port_Position13_N019 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value13_N019 ), NF_PORT_CONSTANT( float( 0.47 ), Port_Position14_N019 ), NF_PORT_CONSTANT( float4( 0.898039, 0.403922, 0.0, 1.0 ), Port_Value14_N019 ), NF_PORT_CONSTANT( float4( 1.0, 0.666667, 0.203922, 1.0 ), Port_Value15_N019 ), Value_N19, Globals );
...
void Node24_Rim( in float3 Normal, in float Exponent, in float Intensity, out float Rim, ssGlobals Globals )
{ 
	...
	Rim = 1.0 - pow( 1.0 - FacingRatio, Exponent );
	Rim = max( Rim, 0.0 );
	Rim *= Intensity;
}
#define Node1_Mix( Input0, Input1, Input2, Output, Globals ) Output = mix( Input0, Input1, float4(Input2) )
#define Node26_Mix( Input0, Input1, Input2, Output, Globals ) Output = mix( Input0, Input1, Input2 )
//-----------------------------------------------------------------------------
...
void main() 
{
	...
	{
		float4 Result_N7 = float4(0.0); Node7_If_else( float( 0.0 ), float4( 0.0, 0.0, 0.0, 0.0 ), float4( 0.0, 0.0, 0.0, 0.0 ), Result_N7, Globals );
		float Rim_N24 = 0.0; Node24_Rim( NF_PORT_CONSTANT( float3( 0.0, 0.0, 0.1 ), Port_Normal_N024 ), NF_PORT_CONSTANT( float( 1.5 ), Port_Exponent_N024 ), NF_PORT_CONSTANT( float( 10.0 ), Port_Intensity_N024 ), Rim_N24, Globals );
		float4 Output_N1 = float4(0.0); Node1_Mix( NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Input0_N001 ), NF_PORT_CONSTANT( float4( 0.890196, 0.698039, 0.388235, 1.0 ), Port_Input1_N001 ), Rim_N24, Output_N1, Globals );
		float4 Output_N26 = float4(0.0); Node26_Mix( Result_N7, Output_N1, NF_PORT_CONSTANT( float4( 0.501961, 0.501961, 0.501961, 0.501961 ), Port_Input2_N026 ), Output_N26, Globals );
