...
#if (sc_ProjectiveShadowsCaster)
{
l9_3=vec4(Port_Albedo_N006,Port_Opacity_N006);
}
#else
{
vec3 l9_4=ssSRGB_to_Linear(Port_Albedo_N006);
vec3 l9_5=normalize(l9_2);
vec3 l9_6=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_7;
#if (sc_SSAOEnabled)
{
l9_7=evaluateSSAO(varPos);
}
#else
{
l9_7=Port_AO_N006;
...
#endif
vec3 l9_8=vec3(Port_Metallic_N006);
vec3 l9_9=mix(vec3(0.039999999),l9_4*Port_Metallic_N006,l9_8);
vec3 l9_10=mix(l9_4*(1.0-Port_Metallic_N006),vec3(0.0),l9_8);
SurfaceProperties l9_11=SurfaceProperties(l9_10,Port_Opacity_N006,l9_5,varPos,l9_0,Port_Metallic_N006,Port_Roughness_N006,l9_6,l9_7,Port_SpecularAO_N006,vec3(1.0),l9_9);
vec4 l9_12=vec4(1.0);
vec3 l9_13;
vec3 l9_14;
vec3 l9_15;
...
{
vec3 l9_51=sc_PointLights[l9_49].position-varPos;
...
#endif
l9_65=sc_EnvmapSpecularSampleViewIndexBias(l9_66,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_67;
...
#endif
l9_67=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_68,sc_EnvmapDiffuseLayout,l9_69,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_67=sc_EnvmapSpecularSampleViewIndexBias(l9_64,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_65=l9_67;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_99=clamp(pow(Port_Roughness_N006,0.66666669),0.0,1.0)*5.0;
vec2 l9_100=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_5,reflect(-l9_0,l9_5),Port_Roughness_N006),sc_EnvmapRotation.y);
vec4 l9_101;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_102=floor(l9_99);
float l9_103=ceil(l9_99);
l9_101=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_100,sc_EnvmapSpecularSize.xy,l9_102),sc_EnvmapSpecularGetStereoViewIndex(),l9_102),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_100,sc_EnvmapSpecularSize.xy,l9_103),sc_EnvmapSpecularGetStereoViewIndex(),l9_103),vec4(l9_99-l9_102));
}
#else
{
l9_101=sc_EnvmapSpecularSampleViewIndexLevel(l9_100,sc_EnvmapSpecularGetStereoViewIndex(),l9_99);
}
#endif
...
#if (sc_LightEstimation)
{
float l9_105=clamp(Port_Roughness_N006*Port_Roughness_N006,0.0099999998,1.0);
vec3 l9_106;
...
l9_119=vec3(0.0);
l9_118=vec3(0.0);
l9_117=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_10,vec3(Port_Opacity_N006));
l9_116=1.0;
}
#else
{
...
vec3 l9_124=l9_104*Port_SpecularAO_N006;
...
{
vec4 l9_132=l9_130;
l9_132.x=l9_129+((l9_7.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_131=l9_132;
}
#else
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_139=clamp(l9_1.w*2.0,0.0,1.0);
}
#else
{
float l9_140;
...
{
l9_140=clamp(dot(l9_1.xyz,vec3(l9_1.w)),0.0,1.0);
}
#else
{
float l9_141;
...
#if (sc_BlendMode_Multiply)
{
l9_142=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_1.w;
}
#else
{
float l9_143;
...
{
l9_143=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_1.w;
}
#else
{
float l9_144;
#if (sc_BlendMode_ColoredGlass)
{
l9_144=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_145;
#if (sc_BlendMode_Add)
{
l9_145=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_146;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_146=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_147;
...
{
l9_147=dot(l9_1.xyz,vec3(0.33333001))*l9_1.w;
}
#else
{
float l9_148;
#if (sc_BlendMode_Min)
{
l9_148=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_149;
#if (sc_BlendMode_Max)
{
l9_149=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_149=1.0;
...
#endif
l9_137=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_138);
}
#else
{
vec4 l9_150;
...
{
vec3 l9_152=sc_GetFramebufferColor().xyz;
vec3 l9_153=mix(l9_152,definedBlend(l9_152,l9_1.xyz).xyz,vec3(l9_1.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_155=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_156;
...
#endif
l9_156=vec4(l9_1.xyz*l9_157,l9_157);
}
#else
{
l9_156=l9_1;
...
{
l9_160=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_160=vec4(0.0);
...
vec4 l9_162=outputMotionVectorsIfNeeded(varPos,max(l9_161,vec4(0.0)));
vec4 l9_163=clamp(l9_162,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_164=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_164-0.0039215689)),min(1.0,l9_164+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_165=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#endif
int l9_166=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_165).xy);
float l9_167=packValue(l9_166);
int l9_174=int(l9_163.w*255.0);
float l9_175=packValue(l9_174);
sc_writeFragData0(vec4(packValue(l9_166),packValue(l9_166),packValue(l9_166),packValue(l9_166)));
sc_writeFragData1(vec4(l9_167,packValue(l9_166),packValue(l9_166),packValue(l9_166)));
sc_writeFragData2(vec4(l9_175,packValue(l9_174),packValue(l9_174),packValue(l9_174)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_178=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_178).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_183==0)
{
l9_186=texture2D(sc_OITAlpha0,l9_178);
l9_185=texture2D(sc_OITDepthLow0,l9_178);
l9_184=texture2D(sc_OITDepthHigh0,l9_178);
}
else
{
l9_186=vec4(0.0);
...
if (l9_183==1)
{
l9_189=texture2D(sc_OITAlpha1,l9_178);
l9_188=texture2D(sc_OITDepthLow1,l9_178);
l9_187=texture2D(sc_OITDepthHigh1,l9_178);
}
else
{
l9_189=l9_186;
...
if (any(notEqual(l9_187,vec4(0.0)))||any(notEqual(l9_188,vec4(0.0))))
{
int l9_190[8]=l9_179;
unpackValues(l9_187.w,l9_183,l9_190);
unpackValues(l9_187.z,l9_183,l9_190);
unpackValues(l9_187.y,l9_183,l9_190);
unpackValues(l9_187.x,l9_183,l9_190);
unpackValues(l9_188.w,l9_183,l9_190);
unpackValues(l9_188.z,l9_183,l9_190);
unpackValues(l9_188.y,l9_183,l9_190);
unpackValues(l9_188.x,l9_183,l9_190);
int l9_199[8]=l9_180;
unpackValues(l9_189.w,l9_183,l9_199);
unpackValues(l9_189.z,l9_183,l9_199);
unpackValues(l9_189.y,l9_183,l9_199);
unpackValues(l9_189.x,l9_183,l9_199);
}
l9_183++;
continue;
}
...
vec4 l9_204=texture2D(sc_OITFilteredDepthBoundsTexture,l9_178);
vec2 l9_205=l9_204.xy;
int l9_206;
#if (sc_SkinBonesCount>0)
{
l9_206=encodeDepth(((1.0-l9_204.x)*1000.0)+getDepthOrderingEpsilon(),l9_205);
}
#else
{
l9_206=0;
...
#endif
int l9_207=encodeDepth(viewSpaceDepth(),l9_205);
vec4 l9_208;
l9_208=l9_163*l9_163.w;
vec4 l9_209;
int l9_210=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_210<8)
{
int l9_211=l9_179[l9_210];
int l9_212=l9_207-l9_206;
bool l9_213=l9_211<l9_212;
bool l9_214;
if (l9_213)
{
l9_214=l9_179[l9_210]>0;
}
else
{
l9_214=l9_213;
...
if (l9_214)
{
vec3 l9_215=l9_208.xyz*(1.0-(float(l9_180[l9_210])/255.0));
l9_209=vec4(l9_215.x,l9_215.y,l9_215.z,l9_208.w);
}
else
{
l9_209=l9_208;
