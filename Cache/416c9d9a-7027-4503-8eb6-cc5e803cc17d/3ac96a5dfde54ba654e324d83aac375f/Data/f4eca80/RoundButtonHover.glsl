...
uniform NF_PRECISION float4 Port_Input1_N035;
...
void main() 
{
	...
	
	{
		...
		float4 Output_N35 = float4(0.0); Node35_Mix( Value_N7, NF_PORT_CONSTANT( float4( 1.0, 0.890852, 0.345098, 1.0 ), Port_Input1_N035 ), Rim_N31, Output_N35, Globals );
		float3 Value1_N23 = float3(0.0); float Value2_N23 = 0.0; Node23_Split_Vector( Output_N35, Value1_N23, Value2_N23, Globals );
