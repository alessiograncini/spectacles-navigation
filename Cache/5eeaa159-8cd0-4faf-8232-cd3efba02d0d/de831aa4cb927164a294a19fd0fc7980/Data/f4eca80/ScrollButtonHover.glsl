...
uniform NF_PRECISION float2 Port_Input1_N008;
uniform NF_PRECISION float2 Port_Input2_N008;
...
uniform NF_PRECISION float Port_Position2_N005;
uniform NF_PRECISION float4 Port_Value2_N005;
uniform NF_PRECISION float4 Port_Value3_N005;
uniform NF_PRECISION float4 Port_Input1_N065;
uniform NF_PRECISION float3 Port_Normal_N064;
uniform NF_PRECISION float Port_Exponent_N064;
uniform NF_PRECISION float Port_Intensity_N064;
uniform NF_PRECISION float2 Port_Input1_N067;
uniform NF_PRECISION float2 Port_Input2_N067;
uniform NF_PRECISION float4 Port_Value0_N069;
uniform NF_PRECISION float Port_Position1_N069;
uniform NF_PRECISION float4 Port_Value1_N069;
uniform NF_PRECISION float Port_Position2_N069;
uniform NF_PRECISION float4 Port_Value2_N069;
uniform NF_PRECISION float Port_Position3_N069;
uniform NF_PRECISION float4 Port_Value3_N069;
uniform NF_PRECISION float4 Port_Value4_N069;
uniform NF_PRECISION float4 Port_Input0_N092;
uniform NF_PRECISION float4 Port_Input1_N092;
uniform NF_PRECISION float3 Port_Normal_N091;
uniform NF_PRECISION float Port_Exponent_N091;
uniform NF_PRECISION float Port_Intensity_N091;
uniform NF_PRECISION float4 Port_Input1_N093;
uniform NF_PRECISION float4 Port_Import_N074;
uniform NF_PRECISION float4 Port_Import_N075;
uniform NF_PRECISION float Port_Input0_N087;
uniform NF_PRECISION float Port_Input1_N087;
uniform NF_PRECISION float Port_RangeMinA_N076;
uniform NF_PRECISION float Port_RangeMaxA_N076;
uniform NF_PRECISION float Port_RangeMinB_N076;
uniform NF_PRECISION float Port_RangeMaxB_N076;
uniform NF_PRECISION float2 Port_CoordsIn_N090;
uniform NF_PRECISION float Port_Rotation_N090;
uniform NF_PRECISION float2 Port_Center_N090;
uniform NF_PRECISION float2 Port_Import_N077;
uniform NF_PRECISION float2 Port_Center_N078;
uniform NF_PRECISION float2 Port_Import_N079;
uniform NF_PRECISION float2 Port_Import_N081;
uniform NF_PRECISION float Port_Input1_N086;
uniform NF_PRECISION float Port_Input2_N086;
uniform NF_PRECISION float2 Port_Input1_N028;
uniform NF_PRECISION float2 Port_Input2_N028;
uniform NF_PRECISION float Port_Value0_N016;
uniform NF_PRECISION float Port_Position1_N016;
uniform NF_PRECISION float Port_Value1_N016;
uniform NF_PRECISION float Port_Position2_N016;
uniform NF_PRECISION float Port_Value2_N016;
uniform NF_PRECISION float Port_Position3_N016;
uniform NF_PRECISION float Port_Value3_N016;
uniform NF_PRECISION float Port_Value4_N016;
#endif	
...
#define Node8_Scale_and_Offset( Input0, Input1, Input2, Output, Globals ) Output = Input0 * Input1 + Input2
void Node5_Gradient( in float Ratio, in float4 Value0, in float Position1, in float4 Value1, in float Position2, in float4 Value2, in float4 Value3, out float4 Value, ssGlobals Globals )
{ 
...
void Node64_Rim( in float3 Normal, in float Exponent, in float Intensity, out float Rim, ssGlobals Globals )
{ 
...
#define Node65_Mix( Input0, Input1, Input2, Output, Globals ) Output = mix( Input0, Input1, float4(Input2) )
#define Node66_Surface_UV_Coord( UVCoord, Globals ) UVCoord = Globals.Surface_UVCoord0
#define Node67_Scale_and_Offset( Input0, Input1, Input2, Output, Globals ) Output = Input0 * Input1 + Input2
#define Node68_Length( Input0, Output, Globals ) Output = length( Input0 )
void Node69_Gradient( in float Ratio, in float4 Value0, in float Position1, in float4 Value1, in float Position2, in float4 Value2, in float Position3, in float4 Value3, in float4 Value4, out float4 Value, ssGlobals Globals )
{ 
	Ratio = clamp( Ratio, 0.0, 1.0 );
...
#define Node62_Add( Input0, Input1, Output, Globals ) Output = Input0 + Input1
void Node91_Rim( in float3 Normal, in float Exponent, in float Intensity, out float Rim, ssGlobals Globals )
{ 
	Normal.xyz = float3x3( Globals.VertexTangent_WorldSpace, Globals.VertexBinormal_WorldSpace, Globals.VertexNormal_WorldSpace ) * Normal.xyz;
...
#define Node92_Mix( Input0, Input1, Input2, Output, Globals ) Output = mix( Input0, Input1, float4(Input2) )
...
#define Node76_Remap( ValueIn, ValueOut, RangeMinA, RangeMaxA, RangeMinB, RangeMaxB, Globals ) ValueOut = ( ( ValueIn - RangeMinA ) / ( RangeMaxA - RangeMinA ) ) * ( RangeMaxB - RangeMinB ) + RangeMinB
void Node90_Rotate_Coords( in float2 CoordsIn, in float Rotation, in float2 Center, out float2 CoordsOut, ssGlobals Globals )
{ 
...
#define Node78_Scale_Coords( CoordsIn, Scale, Center, CoordsOut, Globals ) CoordsOut.xy = ( CoordsIn.xy - Center ) * Scale + Center
#define Node79_Float_Import( Import, Value, Globals ) Value = Import
#define Node80_Subtract( Input0, Input1, Output, Globals ) Output = Input0 - Input1
...
#define Node84_Dot_Product( Input0, Input1, Output, Globals ) Output = dot( Input0, Input1 )
#define Node85_Divide( Input0, Input1, Output, Globals ) Output = Input0 / Input1
#define Node86_Clamp( Input0, Input1, Input2, Output, Globals ) Output = clamp( Input0 + 0.001, Input1 + 0.001, Input2 + 0.001 ) - 0.001
#define Node87_Smoothstep( Input0, Input1, Input2, Output, Globals ) Output = smoothstep( Input0, Input1, Input2 )
#define Node88_Mix( Input0, Input1, Input2, Output, Globals ) Output = mix( Input0, Input1, float4(Input2) )
#define Node89_Float_Export( Value, Export, Globals ) Export = Value
#define Node93_Mix( Input0, Input1, Input2, Output, Globals ) Output = mix( Input0, Input1, Input2 )
#define Node63_Add( Input0, Input1, Output, Globals ) Output = Input0 + Input1
...
void Node16_Gradient( in float Ratio, in float Value0, in float Position1, in float Value1, in float Position2, in float Value2, in float Position3, in float Value3, in float Value4, out float Value, ssGlobals Globals )
{ 
	Ratio = clamp( Ratio, 0.0, 1.0 );
...
#define Node18_Construct_Vector( Value1, Value2, Value, Globals ) Value.rgb = Value1; Value.a = Value2
...
void main() 
{
	...
	{
		float Value_N101 = 0.0; Node101_Float_Import( NF_PORT_CONSTANT( float( 0.1 ), Port_Import_N101 ), Value_N101, Globals );
		...
		float Value_N27 = 0.0; Node27_Float_Import( NF_PORT_CONSTANT( float( 0.9 ), Port_Import_N027 ), Value_N27, Globals );
		...
		float2 Output_N8 = float2(0.0); Node8_Scale_and_Offset( Export_N55.xy, NF_PORT_CONSTANT( float2( 2.0, 1.0 ), Port_Input1_N008 ), NF_PORT_CONSTANT( float2( -0.55, 0.0 ), Port_Input2_N008 ), Output_N8, Globals );
		float4 Value_N5 = float4(0.0); Node5_Gradient( Output_N8.x, NF_PORT_CONSTANT( float4( 0.0500038, 0.0500038, 0.0500038, 1.0 ), Port_Value0_N005 ), NF_PORT_CONSTANT( float( 0.71 ), Port_Position1_N005 ), NF_PORT_CONSTANT( float4( 0.517647, 0.517647, 0.517647, 1.0 ), Port_Value1_N005 ), NF_PORT_CONSTANT( float( 1.0 ), Port_Position2_N005 ), NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value2_N005 ), NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value3_N005 ), Value_N5, Globals );
		float Rim_N64 = 0.0; Node64_Rim( NF_PORT_CONSTANT( float3( 0.0, 0.0, 1.0 ), Port_Normal_N064 ), NF_PORT_CONSTANT( float( 2.0 ), Port_Exponent_N064 ), NF_PORT_CONSTANT( float( 0.45 ), Port_Intensity_N064 ), Rim_N64, Globals );
		float4 Output_N65 = float4(0.0); Node65_Mix( Value_N5, NF_PORT_CONSTANT( float4( 0.552941, 0.552941, 0.552941, 1.0 ), Port_Input1_N065 ), Rim_N64, Output_N65, Globals );
		float2 UVCoord_N66 = float2(0.0); Node66_Surface_UV_Coord( UVCoord_N66, Globals );
		float2 Output_N67 = float2(0.0); Node67_Scale_and_Offset( UVCoord_N66, NF_PORT_CONSTANT( float2( 0.0, 0.25 ), Port_Input1_N067 ), NF_PORT_CONSTANT( float2( 0.0, -0.4 ), Port_Input2_N067 ), Output_N67, Globals );
		float Output_N68 = 0.0; Node68_Length( Output_N67, Output_N68, Globals );
		float4 Value_N69 = float4(0.0); Node69_Gradient( Output_N68, NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value0_N069 ), NF_PORT_CONSTANT( float( 0.0 ), Port_Position1_N069 ), NF_PORT_CONSTANT( float4( 0.0941176, 0.0941176, 0.0941176, 1.0 ), Port_Value1_N069 ), NF_PORT_CONSTANT( float( 0.31 ), Port_Position2_N069 ), NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Value2_N069 ), NF_PORT_CONSTANT( float( 0.66 ), Port_Position3_N069 ), NF_PORT_CONSTANT( float4( 1.0, 0.835294, 0.0, 1.0 ), Port_Value3_N069 ), NF_PORT_CONSTANT( float4( 1.0, 0.835294, 0.0, 1.0 ), Port_Value4_N069 ), Value_N69, Globals );
		float4 Output_N62 = float4(0.0); Node62_Add( Output_N65, Value_N69, Output_N62, Globals );
		float Rim_N91 = 0.0; Node91_Rim( NF_PORT_CONSTANT( float3( 0.0, 0.0, 0.9 ), Port_Normal_N091 ), NF_PORT_CONSTANT( float( 1.0 ), Port_Exponent_N091 ), NF_PORT_CONSTANT( float( 0.45 ), Port_Intensity_N091 ), Rim_N91, Globals );
		float4 Output_N92 = float4(0.0); Node92_Mix( NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 0.0 ), Port_Input0_N092 ), NF_PORT_CONSTANT( float4( 1.0, 0.866667, 0.0, 1.0 ), Port_Input1_N092 ), Rim_N91, Output_N92, Globals );
		float4 Value_N74 = float4(0.0); Node74_Float_Import( NF_PORT_CONSTANT( float4( 1.0, 1.0, 1.0, 1.0 ), Port_Import_N074 ), Value_N74, Globals );
		float4 Value_N75 = float4(0.0); Node75_Float_Import( NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Import_N075 ), Value_N75, Globals );
		float2 UVCoord_N119 = float2(0.0); Node119_Surface_UV_Coord( UVCoord_N119, Globals );
		float2 ValueOut_N76 = float2(0.0); Node76_Remap( UVCoord_N119, ValueOut_N76, NF_PORT_CONSTANT( float( 0.0 ), Port_RangeMinA_N076 ), NF_PORT_CONSTANT( float( 1.0 ), Port_RangeMaxA_N076 ), NF_PORT_CONSTANT( float( -1.0 ), Port_RangeMinB_N076 ), NF_PORT_CONSTANT( float( 1.0 ), Port_RangeMaxB_N076 ), Globals );
		float2 CoordsOut_N90 = float2(0.0); Node90_Rotate_Coords( NF_PORT_CONSTANT( float2( 0.0, 0.0 ), Port_CoordsIn_N090 ), NF_PORT_CONSTANT( float( 90.0 ), Port_Rotation_N090 ), NF_PORT_CONSTANT( float2( 0.5, 0.5 ), Port_Center_N090 ), CoordsOut_N90, Globals );
		float2 Value_N77 = float2(0.0); Node77_Float_Import( CoordsOut_N90, Value_N77, Globals );
		float2 CoordsOut_N78 = float2(0.0); Node78_Scale_Coords( ValueOut_N76, Value_N77, NF_PORT_CONSTANT( float2( 0.5, 0.5 ), Port_Center_N078 ), CoordsOut_N78, Globals );
		float2 Value_N79 = float2(0.0); Node79_Float_Import( NF_PORT_CONSTANT( float2( 0.5, 0.5 ), Port_Import_N079 ), Value_N79, Globals );
		float2 Output_N80 = float2(0.0); Node80_Subtract( CoordsOut_N78, Value_N79, Output_N80, Globals );
		float2 Value_N81 = float2(0.0); Node81_Float_Import( NF_PORT_CONSTANT( float2( 0.0, 0.0 ), Port_Import_N081 ), Value_N81, Globals );
		float2 Output_N82 = float2(0.0); Node82_Subtract( Value_N81, Value_N79, Output_N82, Globals );
		float Output_N83 = 0.0; Node83_Dot_Product( Output_N80, Output_N82, Output_N83, Globals );
		float Output_N84 = 0.0; Node84_Dot_Product( Output_N82, Output_N82, Output_N84, Globals );
		float Output_N85 = 0.0; Node85_Divide( Output_N83, Output_N84, Output_N85, Globals );
		float Output_N86 = 0.0; Node86_Clamp( Output_N85, NF_PORT_CONSTANT( float( 0.0 ), Port_Input1_N086 ), NF_PORT_CONSTANT( float( 1.0 ), Port_Input2_N086 ), Output_N86, Globals );
		float Output_N87 = 0.0; Node87_Smoothstep( NF_PORT_CONSTANT( float( 0.0 ), Port_Input0_N087 ), NF_PORT_CONSTANT( float( 1.0 ), Port_Input1_N087 ), Output_N86, Output_N87, Globals );
		float4 Output_N88 = float4(0.0); Node88_Mix( Value_N74, Value_N75, Output_N87, Output_N88, Globals );
		float4 Export_N89 = float4(0.0); Node89_Float_Export( Output_N88, Export_N89, Globals );
		float4 Output_N93 = float4(0.0); Node93_Mix( Output_N92, NF_PORT_CONSTANT( float4( 0.0, 0.0, 0.0, 1.0 ), Port_Input1_N093 ), Export_N89, Output_N93, Globals );
		float4 Output_N63 = float4(0.0); Node63_Add( Output_N62, Output_N93, Output_N63, Globals );
		float2 UVCoord_N9 = float2(0.0); Node9_Surface_UV_Coord( UVCoord_N9, Globals );
		float2 Output_N28 = float2(0.0); Node28_Scale_and_Offset( UVCoord_N9, NF_PORT_CONSTANT( float2( 0.5, 0.6 ), Port_Input1_N028 ), NF_PORT_CONSTANT( float2( -0.25, -0.54 ), Port_Input2_N028 ), Output_N28, Globals );
		float Output_N29 = 0.0; Node29_Length( Output_N28, Output_N29, Globals );
		float Value_N16 = 0.0; Node16_Gradient( Output_N29, NF_PORT_CONSTANT( float( 0.5 ), Port_Value0_N016 ), NF_PORT_CONSTANT( float( 0.08 ), Port_Position1_N016 ), NF_PORT_CONSTANT( float( 0.6 ), Port_Value1_N016 ), NF_PORT_CONSTANT( float( 0.23 ), Port_Position2_N016 ), NF_PORT_CONSTANT( float( 0.8 ), Port_Value2_N016 ), NF_PORT_CONSTANT( float( 0.56 ), Port_Position3_N016 ), NF_PORT_CONSTANT( float( 0.9 ), Port_Value3_N016 ), NF_PORT_CONSTANT( float( 0.0 ), Port_Value4_N016 ), Value_N16, Globals );
		float4 Value_N18 = float4(0.0); Node18_Construct_Vector( Output_N63.xyz, Value_N16, Value_N18, Globals );
		float4 Output_N100 = float4(0.0); Node100_Add( Output_N2, Value_N18, Output_N100, Globals );
